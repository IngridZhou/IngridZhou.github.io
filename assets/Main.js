...
function createInstructions() {
	...
	text.innerHTML = '<span style="color:' + theme[0] + ';font-size:25px;">Nice To Meet You</span><span style="font-size:15px;">*Drag a ball；<br />*Click on the background；<br />*Shake your browser；<br />*Double-click on the background；<br />*Hold down the left mouse button.</span>';
